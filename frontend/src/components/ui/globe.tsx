...
// Dark, transparent canvas; white markers
const GLOBE_CONFIG_DARK: COBEOptions = {
  ...
  theta: 0.3,
  dark: 1,                 // dark shading
  diffuse: 0.15,           // softer lambert lighting
  mapSamples: 16000,
  mapBrightness: 1.0,      // keep continents visible but subtle
  baseColor: [1, 1, 1], // dark steel
  glowColor: [1, 1, 1], // faint rim light
